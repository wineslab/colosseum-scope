...
public:
  ...
  int cqi_info(uint32_t tti, uint16_t rnti, uint32_t cc_idx, uint32_t cqi_value, uint32_t transmission_mode) final
  {
    return mac.cqi_info(tti, rnti, cc_idx, cqi_value, transmission_mode);
  }
